...
int main (){
  ...
  ALLEGRO_FONT* font = al_load_font("./fonts/font.ttf", 25, 0);
  ALLEGRO_TIMER* timer = al_create_timer(1.0 / 30.0);

  ALLEGRO_BITMAP * sprite = al_load_bitmap("./images/dragon.png");
  ALLEGRO_BITMAP * bg = al_load_bitmap("./images/bg.png");
